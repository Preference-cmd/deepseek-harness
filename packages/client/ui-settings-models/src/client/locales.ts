...
export const en = {
  ...
  retryMaxRetriesPlaceholder: '5 (default)',
  retryMaxRetriesInvalid: 'Max retries must be a non-negative integer.',
  models: 'Models',
  ...
  modelOutputModalities: 'Output modalities',
  modelModalityText: 'Text',
  modelModalityImage: 'Image',
  modelReasoningLevels: 'Reasoning levels',
  modelReasoningLevelsHint: 'None selected = non-reasoning model',
  modelAdvanced: 'More',
  addModel: 'Add model',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  retryMaxRetriesPlaceholder: '5（默认）',
  retryMaxRetriesInvalid: '最大重试次数必须为非负整数。',
  models: '模型目录',
  ...
  modelOutputModalities: '输出模态',
  modelModalityText: '文本',
  modelModalityImage: '图像',
  modelReasoningLevels: '推理档位',
  modelReasoningLevelsHint: '不勾选即视为非推理模型',
  modelAdvanced: '更多',
  addModel: '添加模型',
  removeModel: '删除模型',
