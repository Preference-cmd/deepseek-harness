...
describe('hand-declared providers', () => {
  ...
  it('scopes each card to fields a provider can actually own', async () => {
    ...
    expect(fields()).toEqual([en.keyInput, en.baseUrl, en.retryMaxRetries])
    cleanup()
    ...
    expect(fields()).toEqual([en.keyInput, en.customDisplayName, en.baseUrl, en.retryMaxRetries, en.customApi])
  })
