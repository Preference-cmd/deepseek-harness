...
import { WebSearchManagerCard } from './WebSearchManagerCard.tsx'
import { AGENT_LOOP_NS, AgentLoopCardController } from './agent-loop-card-controller.ts'
import { SHELL_NS, BashCardController } from './bash-card-controller.ts'
import { ConfigurablePluginsTabController } from './tab-store.ts'
import { WEB_SEARCH_NS, WebSearchCardController } from './web-search-card-controller.ts'
import { WEB_SEARCH_MANAGER_NS, WebSearchManagerCardController } from './web-search-manager-card-controller.ts'
...
export type { WebSearchManagerCardFace, WebSearchManagerCardState } from './web-search-manager-card-controller.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  const webSearchManager = new WebSearchManagerCardController(ctx.settingsScope.bind({ namespace: WEB_SEARCH_MANAGER_NS }))
